...
VOID Gk208Constructor(NVIDIA_GPU * Gpu)
{
	KDEBUG("NVIDIA:Chipset:GK208.\n");
	...
	Gpu->VramManager->OneInit = Gk104RamOneInit;
	...
	Gpu->MemoryCopyEngine->Init = Gk104CopyEngineInit;
	...
	Gpu->DisplayEngine->Init = Gk104DisplayInit;
	...
	Gpu->GraphicEngine->Init = Gk208GraphicsEngineInit;
}

VOID Gk208Destructor(NVIDIA_GPU * Gpu)
{
	KDEBUG("GK208 Destructor.\n");
