...
#define SELETOR_KERNEL_CODE_INDEX	1
#define SELETOR_KERNEL_DATA_INDEX	2
#define SELETOR_USER_CODE_INDEX		3
#define SELETOR_USER_DATA_INDEX		4

#define SELECTOR_NULL		(SELECTOR_NULL_INDEX*16)
#define SELETOR_KERNEL_CODE	(SELETOR_KERNEL_CODE_INDEX*16)
#define SELETOR_KERNEL_DATA	(SELETOR_KERNEL_DATA_INDEX*16)
#define SELETOR_USER_CODE	(SELETOR_USER_CODE_INDEX*16)
#define SELETOR_USER_DATA	(SELETOR_USER_DATA_INDEX*16)
