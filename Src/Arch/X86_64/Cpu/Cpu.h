...
#define FLAG_TF BIT8
#define FLAG_IF BIT9
#define FLAG_DF BIT10
#define FLAG_OF BIT11
#define FLAG_NT BIT14
#define FLAG_RF BIT16
#define FLAG_VM BIT17
#define FLAG_AC BIT18
#define FLAG_VIF BIT19
#define FLAG_VIP BIT20
#define FLAG_ID BIT21
#define FLAG_IOPL(Reg) ((Reg & (BIT12 | BIT13)) >> 12)
...
VOID X64GetCpuId(UINT32 EAX, UINT32 ECX, X64_CPUID_BUFFER * Buffer);
UINT64 X64ReadMsr(UINT64 Index);
UINT64 X64WriteMsr(UINT64 Index, UINT64 Value);
UINT64 X64ReadTsc(VOID);
UINT64 X64ReadCr(UINT64 Index);
UINT64 X64WriteCr(UINT64 Index, UINT64 Value);
UINT64 X64ReadDr(UINT64 Index);
UINT64 X64WriteDr(UINT64 Index, UINT64 Value);
UINT64 X64GetFlagsReg(VOID);
VOID X64EnableLocalIrq(VOID);
VOID X64DisableLocalIrq(VOID);
VOID X64GetSpinLock(UINT64 * SpinLock);
VOID X64ReleaseSpinLock(UINT64 * SpinLock);
...
static inline VOID ArchEnableCpuIrq(VOID)
{
	X64EnableLocalIrq();
}

static inline VOID ArchDisableCpuIrq(VOID)
{
	X64DisableLocalIrq();
}
